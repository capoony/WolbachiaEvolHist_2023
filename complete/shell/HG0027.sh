...
bcftools mpileup \
    ...
    -Ou /media/inter/mkapun/projects/WolbachiaEvolHist_2023/results/HG0027/mapping/HG0027.bam |
    bcftools call \
        -O z --ploidy 2 \
        -c \
        -v \
...
bcftools mpileup \
    ...
    -d 1000 \
    -r "ENA|AE017196|AE017196.1" \
    -Ou /media/inter/mkapun/projects/WolbachiaEvolHist_2023/results/HG0027/mapping/380.bam |
    bcftools call \
        -O z --ploidy 2 \
        -c \
        -v \
...
awk -F "\t" '$7>=99 {print $1"\t"$2"\t"$3"\t"$4}' /media/inter/mkapun/projects/WolbachiaEvolHist_2023/results/HG0027/kraken_HG0027_1_blastn.txt |
    uniq >/media/inter/mkapun/projects/WolbachiaEvolHist_2023/results/HG0027/kraken_HG0027_1_blastn_99.txt
...
gunzip /media/inter/mkapun/projects/WolbachiaEvolHist_2023/results/HG0027/GCF_008245065.1_ASM824506v1_genomic.fna.gz

##now do Kraken

Samples=(377 378 HG0034 HG0027 HG0029 HG_20 HG_09)

mkdir /media/inter/mkapun/projects/WolbachiaEvolHist_2023/results/HG0027/kraken
...
for i in ${!Samples[*]}; do
    ...
    ## Redirect output stream to this file.
    #PBS -o /media/inter/mkapun/projects/WolbachiaEvolHist_2023/results/HG0027/kraken/${Sample}_log.txt
    ...
    kraken2 \
        ...
        --gzip-compressed \
        --paired \
        --report /media/inter/mkapun/projects/WolbachiaEvolHist_2023/results/HG0027/kraken/${Sample}.report \
        --use-names \
        --db \$DBNAME \
        --classified-out /media/inter/mkapun/projects/WolbachiaEvolHist_2023/results/HG0027/kraken/${Sample}#.fq \
...
pigz /media/inter/mkapun/projects/WolbachiaEvolHist_2023/results/HG0027/kraken/*.fq
...
mkdir /media/inter/mkapun/projects/WolbachiaEvolHist_2023/results/HG0027/mapping
...
for i in ${!Samples[*]}; do
    ...
    ## Redirect output stream to this file.
    #PBS -o /media/inter/mkapun/projects/WolbachiaEvolHist_2023/results/HG0027/mapping/${Sample}_log.txt
    ...
    #     /media/inter/mkapun/projects/WolbachiaEvolHist_2023/results/HG0027/kraken/${Sample}_1.fq.gz \
    #     /media/inter/mkapun/projects/WolbachiaEvolHist_2023/results/HG0027/kraken/${Sample}_2.fq.gz |
    #     samtools view  -F 4 -bh | samtools sort \
    #     >/media/inter/mkapun/projects/WolbachiaEvolHist_2023/results/HG0027/mapping/${Sample}.bam
...
for i in /media/inter/mkapun/projects/WolbachiaEvolHist_2023/results/HG0027/mapping/*.bam; do

    samtools index $i
    echo $i >>/media/inter/mkapun/projects/WolbachiaEvolHist_2023/results/HG0027/mapping/bamlist.txt

done

samtools depth -f /media/inter/mkapun/projects/WolbachiaEvolHist_2023/results/HG0027/mapping/bamlist.txt >/media/inter/mkapun/projects/WolbachiaEvolHist_2023/results/HG0027/mapping/bamlist.cov
...
for i in ${!Samples[*]}; do
    ...
    grep "^${Start}" /media/inter/mkapun/projects/WolbachiaEvolHist_2023/results/HG0027/mapping/bamlist.cov |
        python /media/inter/mkapun/projects/WolbachiaEvolHist_2023/scripts/cov_Sliding.py \
            --input - \
            --window 5000 \
            --names H11,H12,H03,H05,H04,H09,H20 \
            >/media/inter/mkapun/projects/WolbachiaEvolHist_2023/results/HG0027/mapping/bamlist_${Sample}_1kb.cov

    echo """

library(tidyverse)
DATA=read.table('/media/inter/mkapun/projects/WolbachiaEvolHist_2023/results/HG0027/mapping/bamlist_${Sample}_1kb.cov',header=T)
...
ggsave('/media/inter/mkapun/projects/WolbachiaEvolHist_2023/results/HG0027/mapping/bamlist_${Sample}_1kb.pdf',
    PLOT,
    width=16,
    height=12)

ggsave('/media/inter/mkapun/projects/WolbachiaEvolHist_2023/results/HG0027/mapping/bamlist_${Sample}_1kb.png',
    PLOT,
    width=16,
    height=12)

""" >/media/inter/mkapun/projects/WolbachiaEvolHist_2023/results/HG0027/mapping/bamlist_${Sample}_1kb.r

    Rscript /media/inter/mkapun/projects/WolbachiaEvolHist_2023/results/HG0027/mapping/bamlist_${Sample}_1kb.r

done

cp /media/inter/mkapun/projects/WolbachiaEvolHist_2023/results/HG0027/mapping/bamlist_*_1kb.p* /media/inter/mkapun/projects/WolbachiaEvolHist_2023/output/ReadDepths
