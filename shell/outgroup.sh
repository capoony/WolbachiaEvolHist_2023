...
## Dyak mitochondrium
wget -qO - "https://eutils.ncbi.nlm.nih.gov/entrez/eutils/efetch.fcgi?db=nuccore&id=NC_001322.1&rettype=fasta" \
    >/media/inter/mkapun/projects/WolbachiaEvolHist_2023/data/refseq/data/mtDyak.fasta
...
art_illumina \
    --paired \
    --in /media/inter/mkapun/projects/WolbachiaEvolHist_2023/data/refseq/data/mtDyak.fasta \
    --out /media/inter/mkapun/projects/WolbachiaEvolHist_2023/data/reads/mtDyak-pe100-reads \
    --len 100 \
    --fcov 100 \
    --mflen 400 \
    --sdev 0 \
...
gzip /media/inter/mkapun/projects/WolbachiaEvolHist_2023/data/reads/mtDyak-pe100-*

module load NGSmapper/BBmap-38.90

reformat.sh in=/media/inter/mkapun/projects/WolbachiaEvolHist_2023/data/reads/mtDyak-pe100-reads1.fq.gz \
    out=/media/inter/mkapun/projects/WolbachiaEvolHist_2023/data/reads/mtDyak-pe100-reads1_p33.fq.gz \
    qin=64 qout=33

reformat.sh in1=/media/inter/mkapun/projects/WolbachiaEvolHist_2023/data/reads/mtDyak-pe100-reads2.fq.gz \
    out=/media/inter/mkapun/projects/WolbachiaEvolHist_2023/data/reads/mtDyak-pe100-reads2_p33.fq.gz \
    qin=64 qout=33
...
bwa mem \
    ...
    /media/inter/mkapun/projects/WolbachiaEvolHist_2023/data/reads/mtDyak-pe100-reads1_p33.fq.gz \
    /media/inter/mkapun/projects/WolbachiaEvolHist_2023/data/reads/mtDyak-pe100-reads2_p33.fq.gz |
    samtools view -F 4 -bh | samtools sort \
    >/media/inter/mkapun/projects/WolbachiaEvolHist_2023/results/mapping/mtDyak.bam

echo /media/inter/mkapun/projects/WolbachiaEvolHist_2023/results/mapping/mtDyak.bam \
