...
for ID in 380 HG_16 HG_14 HG_17 HG_18 HG_19 HG_21 HG0021 HG0025 HG0028 HG0035 HG29702 HG47203 376 377 378 HG_09 HG_15 HG_16 HG_20 HG0026 HG0027 HG0029 HG0034 HG47203 HG47204 HG47205 Re1_full Re3 Re6_full Re10 Ak7_full Ak9_full MEL_full CS POP CK2 DGRP335 DGRP338 ED2 ED3 ED6N ED10N EZ2 GA125 KN34 KR7 RG3 RG5 RG34 SP80 TZ14 UG5N ZI268 ZO12 ZS11; do
    ...
    samtools depth $i |
        python /media/inter/mkapun/projects/WolbachiaEvolHist_2023/scripts/mean_depth.py \
            --input - |
        awk -v ID=$ID 'NR>1{print ID"\t"$0}' >/media/inter/mkapun/projects/WolbachiaEvolHist_2023/results/mapping_full/Full_coverages_${ID}_mean.txt &

done

wait

cat /media/inter/mkapun/projects/WolbachiaEvolHist_2023/results/mapping_full/Full_coverages_*_mean.txt | awk '{print $1"\t"$2"\tNA\tNA\tNA\tNA\tNA\t"$3"\tNA\tNA"}' >/media/inter/mkapun/projects/WolbachiaEvolHist_2023/results/mapping_full/Full_coverages_mean.txt
...
python /media/inter/mkapun/projects/WolbachiaEvolHist_2023/scripts/SumReadDepths_median.py \
    ...
    --median /media/inter/mkapun/projects/WolbachiaEvolHist_2023/results/mapping_full/Full_coverages_mean.txt \
    ...
    >/media/inter/mkapun/projects/WolbachiaEvolHist_2023/results/mapping_full/Full_coverages_mean.summary

echo """

library(tidyverse)
library(scales)
DATA=read.table('/media/inter/mkapun/projects/WolbachiaEvolHist_2023/results/mapping_full/Full_coverages_mean.summary',
    header=T)
...
ggsave('/media/inter/mkapun/projects/WolbachiaEvolHist_2023/results/mapping_full/Full_coverages_full_mean2.pdf',
    PLOT,
    width=10,
    height=6)

ggsave('/media/inter/mkapun/projects/WolbachiaEvolHist_2023/results/mapping_full/Full_coverages_full_mean2.png',
    PLOT,
    width=10,
    height=6)

""" >/media/inter/mkapun/projects/WolbachiaEvolHist_2023/results/mapping_full/Full_coverages_mean2.r

Rscript /media/inter/mkapun/projects/WolbachiaEvolHist_2023/results/mapping_full/Full_coverages_mean2.r
