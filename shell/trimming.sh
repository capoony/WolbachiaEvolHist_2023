...
trim_galore   --paired   --quality 20   --length 30    --cores 20   --fastqc   --gzip   /media/inter/mkapun/projects/WolbachiaEvolHist_2023/data/reads/${ID}_1.fastq.gz   /media/inter/mkapun/projects/WolbachiaEvolHist_2023/data/reads/${ID}_2.fastq.gz
...
trim_galore --quality 20 --length 30 --cores 20 --fastqc --gzip /media/inter/mkapun/projects/WolbachiaEvolHist_2023/data/reads/${ID}.fastq.gz
