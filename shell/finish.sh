Samples=(HG_09 HG_15 HG_16 HG_20 HG0026 HG47203 HG47204)
NewName=(Germany_Passau_1800_HG_09 Sweden_Lund_1933_HG_15 Sweden_Lund_1933_HG_16 Sweden_Lund_1933_HG_20 Sweden_Lund_1933_HG0026 Sweden_Lund_1933_HG47203 Sweden_Lund_1933_HG47204)
for i in ${!Samples[*]}; do
    Sample=${Samples[i]}
    New=${NewName[i]}
    echo $i ${Sample} ${New}
